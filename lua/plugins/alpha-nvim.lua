...
dashboard.section.buttons.val = {
	...
	dashboard.button("t", "  Browse cwd", ":NvimTreeOpen<Cs>"),
	dashboard.button("r", "  Browse notes", ":e ~/Desktop/bale/<CR>"),
	dashboard.button("s", "󰯂  Browse scripts", ":e ~/Desktop/scripts/<CR>"),
